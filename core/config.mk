...
ifneq ($(EPIC_BUILD),)
include vendor/epic/config/BoardConfigEpic.mk
endif
...
ifneq ($(EPIC_BUILD),)
ifneq ($(wildcard device/epic/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/epic/sepolicy/common/sepolicy.mk)
endif
endif
